...
!function (t, e) {
  ...
  var Ct,
      ...
      Tt,
      Nt,
      Ft = (t(Mt, kt = bt), Mt.prototype.assign = function (t) {
  ...
  var nr = er.alea,
    ...
    return t <= this.upper && t >= this.lower;
      ...
      or = (sr.prototype.nextValue = function () {
    for (var t, e, n, r, o, i;;) {
    ...
    return "float32" === this.dtype ? t : Math.round(t);
      ...
      ir = (ar.prototype.convertValue = function (t) {
  ...
  var so = wn({
    ...
    return this.dataIdsCount;
      ...
      lo = (ho.prototype.time = function (t) {
    return po("time");
  ...
  var yi = "return a + b;",
    ...
    return function (t, e) {
      ...
      _i = (Ii.prototype.getCustomSetupFunc = function (n, r) {
    var o = this;
    return function (t, e) {
      null == o.minLoc && (o.minLoc = t.getUniformLocationNoThrow(e, "minVal"), o.maxLoc = t.getUniformLocationNoThrow(e, "maxVal")), t.gl.uniform1f(o.minLoc, n), t.gl.uniform1f(o.maxLoc, r);
    };
  ...
  var $i = (Zi.prototype.getHeightCoordString = function () {
    ...
    return "NHWC" === this.dataFormat ? "getX(b, in_h, in_w, in_d)" : "getX(b, in_d, in_h, in_w)";
      ...
      Ji = (Qi.prototype.getCustomSetupFunc = function (n) {
    var r = this;
    return function (t, e) {
  ...
  var ya = Object.freeze({
    ...
    this.itemsToPoll.push({
      isDoneFn: t,
      resolveFn: e
    }), 1 < this.itemsToPoll.length || k(function () {
  ...
  var Ds,
      As = (t(Ts, Ds = lo), Ts.prototype.numDataIds = function () {
    ...
    if (v && (h = this.startTimer()), function (a, s, t, e, n) {
      ...
      e.texData.isPacked ? a.setOutputPackedMatrixTexture(r, o[0], o[1]) : a.setOutputMatrixTexture(r, o[0], o[1]), a.setProgram(s.webGLProgram), 1 === _().getNumber("WEBGL_VERSION") && null !== s.infLoc && a.gl.uniform1f(s.infLoc, 1 / 0), null !== s.nanLoc && a.gl.uniform1f(s.nanLoc, NaN), t.forEach(function (t, e) {
        ...
        if (null != r) if (t.isUniform) {
          if (L(t.shape) < 2) a.gl.uniform1f(r, t.uniformValues[0]);else {
  ...
  function xc(t, e, r, o, i, a, s) {
    ...
    var f = Do(a),
        ...
        d = Kt.runKernelFunc(function (t, e) {
  ...
  var Cc = wn({
    ...
    conv3d_: function (t, e, o, i, n, a) {
      ...
      var h = wo(c.shape, u.shape, o, a, i),
          f = Kt.runKernelFunc(function (t, e) {
    ...
    depthwiseConv2d_: function (t, e, n, r, o, i, a) {
      ...
      var h = bo(c.shape, u.shape, n, i, r, a, !0),
          f = [c, u],
          p = Kt.runKernelFunc(function (t, e) {
  ...
  function Uc(t, r, o, i, a, e) {
    ...
    var l = [s],
        h = Kt.runKernelFunc(function (t, e) {
      var n = t.maxPool(s, c);
      return e([s, n]), n;
    }, {
      x: s
  ...
  var tl = wn({
    ...
    max_: function (t, e, n) {
      ...
      var u = [r],
          c = Kt.runKernelFunc(function (t, e) {
        var n = t.max(r, a);
        return e([o, n]), n;
      }, {
        x: r
  ...
  var lh = wn({
    resizeBilinear_: function (t, e, r) {
      ...
      var a = e[0],
          s = e[1],
          u = Kt.runKernelFunc(function (t, e) {
    ...
    nonMaxSuppressionWithScore_: function (t, e, n, r, o, i) {
      ...
      var a = cn(t, "boxes", "nonMaxSuppression"),
        ...
        softNmsSigma: i = u.softNmsSigma
          ...
          l = Kt.runKernel("NonMaxSuppressionV5", {
        boxes: a,
        scores: s
      }, c);
      return {
    ...
    fusedConv2d_: function (t) {
      ...
      var E = [m, g],
          _ = Kt.runKernelFunc(function (t, e) {
        var n = t.fusedConv2d({
          input: g,
          filter: m,
          convInfo: w,
  ...
  var Eh,
      _h = (t(Ih, Eh = lo), Ih.prototype.write = function (t, e, n) {
    ...
    return Vo(t, e, n);
  }, Ih.prototype.dispose = function () {}, Ih.prototype.floatPrecision = function () {
    return 32;
  ...
  var Bh,
      Lh = (Wh.prototype.fetch = function (t, e) {
      ...
      return R(this, function (t) {
        switch (t.label) {
          ...
          case 1:
            ...
            })), (i = null == this.jsonAnchor ? document.createElement("a") : this.jsonAnchor).download = this.modelTopologyFileName, i.href = o, [4, If(function () {
  ...
  var Lf = (Uf.prototype.load = function () {
    return y(this, void 0, void 0, function () {
      ...
      Wf = (zf.prototype.save = function (e) {
    return y(this, void 0, void 0, function () {
      return R(this, function (t) {
  ...
  var Vf,
    ...
    fromMemory: function (t, e, n, r) {
      return 1 === arguments.length ? null != t.modelTopology || null != t.weightSpecs ? new Lf(t) : (console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new Lf({
        modelTopology: t
      })) : (console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new Lf({
        modelTopology: t,
        weightSpecs: e,
        weightData: n,
        trainingConfig: r
    ...
    fromPixels_: function (t, e) {
      ...
      if (null != g("FromPixels", Kt.backendName)) return Kt.runKernel("FromPixels", {
        pixels: t
      }, {
        numChannels: e
      });
  ...
  var up,
      cp = (t(lp, up = ap), lp.prototype.applyGradients = function (n) {
    var u = this;
  ...
  Qf(cp);
  var hp,
      fp = (t(pp, hp = ap), pp.prototype.applyGradients = function (i) {
    var a = this;
  ...
  Qf(fp);
  var dp,
      vp = (t(mp, dp = ap), mp.prototype.applyGradients = function (p) {
    var d = this,
        t = Array.isArray(p) ? p.map(function (t) {
      return t.name;
    }) : Object.keys(p);
    nn(function () {
  ...
  Qf(vp);
  var gp,
      yp = (t(xp, gp = ap), xp.prototype.applyGradients = function (p) {
    var d = this,
        t = Array.isArray(p) ? p.map(function (t) {
      return t.name;
    }) : Object.keys(p);
  ...
  Qf(yp);
  var bp,
      wp = (t(Cp, bp = ap), Cp.prototype.applyGradients = function (o) {
    var i = this;
  ...
  var Ep,
      _p = (t(Ip, Ep = wp), Ip.prototype.applyGradients = function (i) {
    var a = this;
    (Array.isArray(i) ? i.map(function (t) {
      return t.name;
    }) : Object.keys(i)).forEach(function (t, e) {
  ...
  Qf(_p);
  var Rp,
      kp = (t(Sp, Rp = ap), Sp.prototype.applyGradients = function (e) {
    var h = this;
  ...
  var id = (ad.isRect = function (t) {
    ...
    var t = this.x,
        ...
        r = this.height,
        o = Math.abs(n - r);
    return n < r && (t -= o / 2, n += o), r < n && (e -= o / 2, r += o), new ad({
      x: t,
      y: e,
      width: n,
      height: r
  ...
  function cd(t, e, n, r, o) {
    return void 0 === o && (o = !1), sd.call(this, {
      left: t,
      top: e,
      right: n,
      bottom: r
  ...
  var ld = (Object.defineProperty(hd.prototype, "score", {
    ...
    return new hd(this.score, this.classScore, this.className, this.relativeBox, {
      width: t,
      height: e
    });
  }, hd);
  ...
  var fd,
      pd = (Pp(dd, fd = ld), dd.prototype.forSize = function (t, e) {
  ...
  function Ed(t, e, n, r, o) {
    return void 0 === o && (o = !1), wd.call(this, {
      x: t,
      y: e,
      width: n,
      height: r
  ...
  var Rd,
      kd = (Pp(Sd, Rd = _d), Sd.prototype.getRefPointsForAlignment = function () {
  ...
  var Dd,
      Ad = (Pp(Td, Dd = _d), Td.prototype.getJawOutline = function () {
  ...
  var Md,
      Od = (Pp(Pd, Md = id), Pd.assertIsValidLabeledBox = function (t, e) {
  ...
  var Wd,
      zd,
      Ud = (Pp(Vd, Wd = Od), Vd.assertIsValidPredictedBox = function (t, e) {
  ...
  var Hv,
      qv = (Pp(jv, Hv = kv), jv.prototype.forwardInput = function (e) {
    var n = this.params;
  ...
  var Yv,
      $v = (Pp(Jv, Yv = kv), Object.defineProperty(Jv.prototype, "faceFeatureExtractor", {
    get: function () {
  ...
  var em,
      nm = (Pp(rm, em = $v), rm.prototype.forwardInput = function (t) {
    var e = this;
    return nn(function () {
  ...
  var mm,
      gm,
      ym = (Pp(xm, mm = kv), xm.prototype.forwardInput = function (n) {
    var r = this,
        o = this.params;
  ...
  var bm,
      wm = (Pp(Cm, bm = kv), Object.defineProperty(Cm.prototype, "faceFeatureExtractor", {
    get: function () {
      return this._faceFeatureExtractor;
    },
    enumerable: !0,
    ...
    return nn(function () {
      ...
      return {
        age: Kv(e, o.fc.age).as1D(),
        gender: Kv(e, o.fc.gender)
      };
    });
  ...
  var Em,
      _m = (Pp(Im, Em = $v), Im.prototype.postProcess = function (t, o, e) {
  ...
  var Rm,
      km = (Pp(Sm, Rm = _m), Sm.prototype.getDefaultModelName = function () {
  ...
  var Dm,
      Am = (Pp(Tm, Dm = kv), Tm.prototype.forwardInput = function (e) {
    var n = this.params;
  ...
  var Nm,
      Fm = (Pp(Mm, Nm = _m), Mm.prototype.getDefaultModelName = function () {
  ...
  var qm,
      jm = (Pp(Km, qm = kv), Km.prototype.forwardInput = function (n) {
    var r = this.params;
  ...
  var cg,
      lg = (Pp(hg, cg = kv), hg.prototype.forwardInput = function (r) {
    var o = this.params;
  ...
  var Dg,
      Ag = (Pp(Tg, Dg = kv), Object.defineProperty(Tg.prototype, "config", {
    get: function () {
      return this._config;
    },
    enumerable: !0,
  ...
  var Ng,
      Fg = (Pp(Mg, Ng = Ag), Object.defineProperty(Mg.prototype, "withSeparableConvs", {
    get: function () {
  ...
  var ry,
      oy = (Pp(iy, ry = kv), iy.prototype.load = function (e) {
    return Lp(this, void 0, void 0, function () {
      return Wp(this, function (t) {
  ...
  var ay,
      ...
      cy = (Pp(ly, ay = Ag), Object.defineProperty(ly.prototype, "anchors", {
    get: function () {
      return this.config.anchors;
    },
    enumerable: !0,
  ...
  var wy,
      Cy = (Pp(Ey, wy = xy), Ey.prototype.run = function () {
    return Lp(this, void 0, void 0, function () {
      var e,
          n,
          r = this;
  ...
  var _y,
      Iy = (Pp(Ry, _y = xy), Ry.prototype.run = function () {
    return Lp(this, void 0, void 0, function () {
      var e, n;
      return Wp(this, function (t) {
        switch (t.label) {
  ...
  var ky,
      Sy = (Pp(Dy, ky = Cy), Dy.prototype.withAgeAndGender = function () {
  ...
  var Ay,
      Ty = (Pp(Ny, Ay = Iy), Ny.prototype.withAgeAndGender = function () {
  ...
  var Py,
      By = (Pp(Ly, Py = My), Ly.prototype.run = function () {
    return Lp(this, void 0, void 0, function () {
      var e,
          o,
          n = this;
  ...
  var Wy,
      zy = (Pp(Uy, Wy = My), Uy.prototype.run = function () {
    return Lp(this, void 0, void 0, function () {
      var e, n, r, o, i;
      return Wp(this, function (t) {
        switch (t.label) {
  ...
  var Vy,
      Gy = (Pp(Hy, Vy = By), Hy.prototype.withFaceExpressions = function () {
  ...
  var qy,
      jy = (Pp(Ky, qy = zy), Ky.prototype.withFaceExpressions = function () {
  ...
  var Jy,
      Qy = (Pp(Zy, Jy = Yy), Zy.prototype.run = function () {
    return Lp(this, void 0, void 0, function () {
      var n;
      return Wp(this, function (t) {
        switch (t.label) {
  ...
  var tx,
      ex = (Pp(nx, tx = Yy), nx.prototype.run = function () {
    return Lp(this, void 0, void 0, function () {
      var e, n;
      return Wp(this, function (t) {
        switch (t.label) {
  ...
  var rx,
      ox = (Pp(ix, rx = Lg), Object.defineProperty(ix.prototype, "landmarkNet", {
    get: function () {
  ...
  var ax,
      sx = (Pp(ux, ax = ox), ux.prototype.run = function () {
    return Lp(this, void 0, void 0, function () {
      var e,
          n,
          r,
  ...
  var cx,
      lx = (Pp(hx, cx = ox), hx.prototype.run = function () {
    return Lp(this, void 0, void 0, function () {
      var e, n, r, o, i;
      return Wp(this, function (t) {
        switch (t.label) {
  ...
  var vx,
      mx = (Pp(gx, vx = px), gx.prototype.run = function () {
    return Lp(this, void 0, void 0, function () {
      var e, n, r, o;
      return Wp(this, function (t) {
        switch (t.label) {
  ...
  var yx,
      xx = (Pp(bx, yx = px), bx.prototype.run = function () {
    return Lp(this, void 0, void 0, function () {
      var e, n;
      return Wp(this, function (t) {
        switch (t.label) {
  ...
  function Cx(e, n) {
    return Lp(this, void 0, void 0, function () {
      return Wp(this, function (t) {
        switch (t.label) {
          case 0:
            return console.warn("allFacesSsdMobilenetv1 is deprecated and will be removed soon, use the high level api instead"), [4, wx(e, new sg(n ? {
              minConfidence: n
  ...
  }, c.toNetInput = bv, c.utils = nd, c.validateConfig = wg, Object.defineProperty(c, "__esModule", {
    value: !0
  });
});